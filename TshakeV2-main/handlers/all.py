...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/almohajrina_walansar_documents
")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/almohajrina_walansar
")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/homespeople2")]])
