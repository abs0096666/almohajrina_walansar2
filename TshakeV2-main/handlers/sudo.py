...
")]])
		...
		if rank is "sudo" or rank is "asudo":
			...
			if text == c.ADDfiles:
				url = "https://raw.githubusercontent.com/almohajrina_walansar
2/TshakeV2-files/master/files"
			...
			if text == c.Ubot:
				...
				for fnh in Files_H:
					url = "https://raw.githubusercontent.com/almohajrina_walansar
2/TshakeV2/master/handlers/"+fnh
